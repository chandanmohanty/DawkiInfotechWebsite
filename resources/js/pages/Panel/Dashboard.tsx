            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Welcome to the admin panel. This is your dashboard.
                    </p>
                </div>
                ...
                <div className="overflow-hidden rounded-lg bg-white shadow">
                    <div className="p-6">
                        <h2 className="text-lg font-semibold text-gray-900">Welcome to Admin Panel</h2>
                        <p className="mt-2 text-sm text-gray-600">
                            This is your dashboard. You can start building your admin features here.
                            The panel is ready for you to add more functionality as needed.
                        </p>
                    </div>
                </div>
            </div>
